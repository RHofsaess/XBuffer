#!/bin/bash
# This script sets up logging and starts a remote data transfer

# set permissions
chmod -R 777 /logs/

touch /logs/client_remote.log
echo "START: $(date) ----------------------------" > /logs/client_remote.log
...
#xrdcp -d 2 -f root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/B7AA7F04-5D5F-514A-83A6-9A275198852C.root /logs &> /logs/client_remote.log
#xrdcp -d 2 -f root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/8A696857-C147-B04A-905A-F85FB76EDA23.root /logs &> /logs/client_remote.log
#xrdcp -d 2 -f root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/B7AA7F04-5D5F-514A-83A6-9A275198852C.root /logs &> /logs/client_remote.log
#xrdcp -d 2 -f root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/8A696857-C147-B04A-905A-F85FB76EDA23.root /logs &> /logs/client_remote.log
#xrdcp -d 2 -f root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/F5E234F9-1E9C-0042-B395-AB6407E4A336.root /logs &> /logs/client_remote.log